...
class PlatinumSubscription extends StatefulWidget {
  const PlatinumSubscription({super.key});

  @override
  _PlatinumSubscriptionState createState() => _PlatinumSubscriptionState();
}

class _PlatinumSubscriptionState extends State<PlatinumSubscription> {
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: Color(0xFFE5E4E2).withOpacity(0.2),
