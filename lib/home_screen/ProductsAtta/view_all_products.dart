...
class AllAttaProductsPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GridView.builder(
        ...
        itemCount: bestSellingAttaProducts.length,
        itemBuilder: (context, index) {
          var product = bestSellingAttaProducts[index];
          return buildBestAttaCard(product);
        },
      ),
    );
  }
