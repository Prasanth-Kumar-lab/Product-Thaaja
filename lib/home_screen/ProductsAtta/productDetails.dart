...
class ProductAttaDetails extends StatelessWidget {
  final ProductAtta atta;
  const ProductAttaDetails({Key? key, required this.atta}) : super(key: key);
  @override
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Obx(() {
              return Icon(
                favoriteController.isAttaFavorite(atta)
                    ? Icons.favorite
                ...
                Row(
                  ...
                  children: [
                    ...
                    Obx(() {
                      ...
                      double totalPrice = count > 0 ? count * atta.price : atta.price;
                      return Text(
