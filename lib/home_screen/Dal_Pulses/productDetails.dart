...
class DalPulsesDetails extends StatelessWidget {
  final ProductDalPulses dalPulses;
  const DalPulsesDetails({Key? key, required this.dalPulses}) : super(key: key);
  @override
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Obx(() {
              return Icon(
                favoriteController.isDalFavorite(dalPulses)
                    ? Icons.favorite
                ...
                Row(
                  ...
                  children: [
                    ...
                    Obx(() {
                      ...
                      double totalPrice = count > 0 ? count * dalPulses.price : dalPulses.price;
                      return Text(
